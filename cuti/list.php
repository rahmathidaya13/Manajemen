                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="align-middle d-flex justify-content-center">
                                                ...
                                                <a class="btn btn-danger btn-sm mr-2" onclick="return confirm('Apakah yakin data ini dihapus?')" href="delete.php?delete=<?php echo $rows['id_cuti'] ?>"> <i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
...
<?php elseif ($data['level'] == 'user') : ?>
    <?php include 'user-only/list.php' ?>
<?php endif; ?>
